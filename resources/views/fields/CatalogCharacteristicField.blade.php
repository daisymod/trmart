<div class="form-group relation-box">
    <div class="relation-name">{{ __($class->name) }}</div>
    <div class="relation-form-box" data-url="{{ route("field.catalog_characteristic") }}" data-field="{{ $class->field }}" data-multiple="{{ $class->multiple }}">
