...
class CatalogItemMerchantSearchForm extends BasicForm
{
    ...
    public static array $formFields = [
        ...
        "article" => [TextboxField::class],
        "barcode" => [TextboxField::class],
        "country" => [LocationField::class, "find" => false],
        "price_from" => [TextboxField::class],
        "price_to" => [TextboxField::class],
        "equipment" => [LanguageTextboxField::class, "find" => false],
        "image" => [ImagesField::class, "width" => 400, "height" => 400, "find" => false],
